...
$(document).ready(function () {
    ...
    if (tt.length > 0) {
      ...
      //  debugger;
        ...
        // debugger;
        if (tt[1].L1Status == 4 || tt[1].L1Status == 5) {
    ...
    $("#btnback").click(function () {
        ...
        if (Modernizr.localstorage) {
            ...
            //-----------------------AI Status-------------On 15-07-2017--------------------
            //$("#aival").removeClass();
            //if (tt[backcnt].AIStatus != "Not in POC") {
            //    if (tt[backcnt].AIStatus == "Accepted") {
            //        document.getElementById("aival").classList.add("w3-highway-green");
            //    }
            //    else {
            //        document.getElementById("aival").classList.add("w3-highway-red");
            //    }
            //    document.getElementById('aival').innerHTML = tt[backcnt].AIStatus;
            //    document.getElementById('aidisplay').style.display = "";
            //}
            //else {
            //    document.getElementById('aival').innerHTML = "";
    ...
    $("#btnClose").click(function () {
        ...
        if (Modernizr.localstorage) {
            ...
            $.ajax({
                ...
                url: RootUrl + 'TFL2Verification/TFl2',
                ...
                success: function (result) {
                    if (result == false) {
                        window.location = RootUrl + 'TFL2Verification/Selection';
                    }
                }
    ...
    function common(val) {
        ...
        if (cnt < tt.length) {
            ...
            document.getElementById('l1decision').innerHTML = ""
            document.getElementById('L1rejectDecrp').innerHTML = ""
            if (tt[cnt].L1Status == 4 || tt[cnt].L1Status == 5) {
                //document.getElementById('l1dec').style.display = "";
    ...
    getcbsdtls = function () {
        ...
        if (Acct == "") {
            ...
            $.ajax({
                url: RootUrl + 'TFL2Verification/GetCBSDtls',
                dataType: 'html',
                type: 'POST',
                data: { ac: $("#accnt").val() },
                success: function (data) {
...
function bankName(bankcode) {
    // alert('hello');
    $.ajax({
        url: RootUrl + 'TFL2Verification/GetBankName',
        dataType: 'html',
...
function getIwlogs() {
    ...
    $.ajax({
        url: RootUrl + 'TFL2Verification/getIwlogs',
        dataType: 'html',
        data: { id: $("#mtrn").val() },
        success: function (data) {
            //alert(data);
