...
$(document).ready(function () {
    ...
    getcbsdtls = function () {
        ...
        if (Acct == "") {
            ...
            $.ajax({
                url: RootUrl + 'TFL1verification/GetCBSDtls',
                dataType: 'html',
                type: 'POST',
                data: { ac: $("#accnt").val() },
    ...
    if (tt.length > 0) {
        ...
        document.getElementById('iwAmt').value = addCommas(Number(tt[1].XMLAmount).toFixed(2));
        ...
        if (result == false) {
            ...
            if (backbtn == true) {
                ...
                L1 = {
                    ...
                    "ActualAmount": parseFloat($("#iwAmt").val().replace(/,/g, '')),
                    "Date": $("#ChqDate").val(),
    ...
    $("#btnback").click(function () {
        ...
        if (Modernizr.localstorage) {
            ...
            //---------------------Filling cbsDetails------
            $.ajax({
                url: '/TFL1verification/GetCBSDtls',
                dataType: 'html',
                type: 'POST',
    ...
    $("#btnClose").click(function () {
        ...
        if (Modernizr.localstorage) {
            ...
            $.ajax({
                ...
                url: RootUrl + 'TFL1verification/TFl1',
                ...
                success: function (result) {
                    if (result == false) {
                        window.location = RootUrl + 'TFL1verification/Selection';
                    }
                }
            });
        }
    ...
    function common(val) {
        ...
        if (cnt < tt.length) {
            ...
            // document.getElementById('xmlamt').innerHTML = addCommas(Number(tt[cnt].XMLAmount).toFixed(2)); //tt[1].XMLAmount;tt[cnt].XMLAmount;
            document.getElementById('iwAmt').value = addCommas(Number(tt[cnt].XMLAmount).toFixed(2));
            document.getElementById('ChqDate').value = fnldate;
                    ...
                    success: function (result) {
                        if (result == false) {
                            ...
                            if (tt != null && tt != "") {
                                ...
                                document.getElementById('SANQC').value = tt[1].XMLSAN;
                                document.getElementById('TransQC').value = tt[1].XMLTransCode;
                                //document.getElementById('xmlamt').innerHTML = addCommas(Number(tt[1].XMLAmount).toFixed(2)); //tt[1].XMLAmount;
                                document.getElementById('iwAmt').value = addCommas(Number(tt[1].XMLAmount).toFixed(2));
                                document.getElementById('ChqDate').value = fnldate;
                                document.getElementById('accnt').value = tt[1].DbtAccountNo;
...
function IWLICQC() {
    ...
    //----------------------------Amount---------------------//
    //debugger;
    amt = $("#iwAmt").val().replace(/,/g, '');//document.getElementById('iwAmt').value;
    //alert(amt);   
    var intcont = 0;
    ...
    if (tt[tempacnt].XMLAmount != parseFloat($("#iwAmt").val().replace(/,/g, '')) && IWdecn == "A") {
...
function MatchAmt(indexvl) {
    var match = 0;
    var tempAmount = parseFloat($("#iwAmt").val().replace(/,/g, ''));//document.getElementById('iwAmt').value;
