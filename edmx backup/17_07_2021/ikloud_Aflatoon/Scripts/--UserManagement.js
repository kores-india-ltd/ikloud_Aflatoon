$(document).ready(function () {
    ...
    //$('#ok').click(function () {
    //    alert('ok');
    //    var obj = ($("#EmpList option:selected"));
    //    var message = "";
    ...
    //    if ($("#CustBag").val() != null && $("#CustBag").val() != "") {
    //        $.ajax({
    //            url: RootUrl + 'CreateUser/_SelectDomains',
    //            data: JSON.stringify({ customerIds: $("#CustBag").val() }),
    //            type: 'POST',
    ...
    $('#Org').change(function () {
        ...
        if ($("#Org").val() != null && $("#Org").val() != "") {
            ...
            //    data: JSON.stringify({ customerlist: $("#Org").val() }),
            //    type: 'POST',
            //    contentType: 'application/json; charset=utf-8',
            //    dataType: 'html',
            //    //async: false,
    ...
    $("#slogin").click(function () {
        ...
        $.ajax({
            ...
            type: "POST",
            dataType: "html",
            data: { uname: $("#user").val(), upass: $("#passd").val(), procdate: $("#ProcessingDate").val(), custid: $('#CustomerId').val(), loglevel: "User" },
            success: function (data) {
                // debugger;
                if (data == "true") {
