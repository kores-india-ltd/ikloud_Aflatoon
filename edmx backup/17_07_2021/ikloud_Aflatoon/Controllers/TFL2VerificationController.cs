...
{
    public class TFL2VerificationController : Controller
    {
        //
        // GET: /TFL2Verification/
        ...
        public ActionResult Index(string clrtype = null)
        {
            ...
            try
            {
                ...
                SqlDataAdapter adp = new SqlDataAdapter("TFL2Verification", con);
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    def = new L2Helper
                    {
                        ...
                        ReturnReasonDescription = ds.Tables[0].Rows[0].ItemArray[10].ToString(),

                        FrontGreyImagePath = ds.Tables[0].Rows[0].ItemArray[11].ToString().Replace((string)Session["SrcWebIP"], (string)Session["DestWepIP"]).Replace((string)Session["SrcWebName"], (string)Session["DestWebName"]),
                        FrontTiffImagePath = ds.Tables[0].Rows[0].ItemArray[12].ToString().Replace("tif", "jpg").Replace((string)Session["SrcWebIP"], (string)Session["DestWepIP"]).Replace((string)Session["SrcWebName"], (string)Session["DestWebName"]),
                        CBSClientAccountDtls = ds.Tables[0].Rows[0].ItemArray[13].ToString(),
                        CBSJointHoldersName = ds.Tables[0].Rows[0].ItemArray[14].ToString(),
                        L1Status = Convert.ToInt32(ds.Tables[0].Rows[0].ItemArray[15]),
                        PresentingBankRoutNo = ds.Tables[0].Rows[0].ItemArray[16].ToString(),
                        DocType = ds.Tables[0].Rows[0].ItemArray[17].ToString(),
                        XMLMICRRepairFlags = ds.Tables[0].Rows[0].ItemArray[18].ToString(),
                        BackTiffImagePath = ds.Tables[0].Rows[0].ItemArray[19].ToString().Replace("tif", "jpg").Replace((string)Session["SrcWebIP"], (string)Session["DestWepIP"]).Replace((string)Session["SrcWebName"], (string)Session["DestWebName"]),
                        ...
                        //  AIStatus = ds.Tables[0].Rows[0].ItemArray[27].ToString(),
                    ...
                    while (count > 0)
                    {
                        def = new L2Helper
                        {
                            ...
                            //RejectDescription = ds.Tables[0].Rows[0].ItemArray[9].ToString(),
                            //L1By = Convert.ToInt32(ds.Tables[0].Rows[0].ItemArray[15]),
                            ReturnReasonDescription = ds.Tables[0].Rows[index].ItemArray[10].ToString(),
                            ...
                            CBSClientAccountDtls = ds.Tables[0].Rows[index].ItemArray[13].ToString(),
                            CBSJointHoldersName = ds.Tables[0].Rows[index].ItemArray[14].ToString(),
                            L1Status = Convert.ToInt32(ds.Tables[0].Rows[index].ItemArray[15]),
                            PresentingBankRoutNo = ds.Tables[0].Rows[index].ItemArray[16].ToString(),
                            DocType = ds.Tables[0].Rows[index].ItemArray[17].ToString(),
                            XMLMICRRepairFlags = ds.Tables[0].Rows[index].ItemArray[18].ToString(),
                            BackTiffImagePath = ds.Tables[0].Rows[index].ItemArray[19].ToString().Replace("tif", "jpg").Replace((string)Session["SrcWebIP"], (string)Session["DestWepIP"]).Replace((string)Session["SrcWebName"], (string)Session["DestWebName"]),
                            // OpsStatus = Convert.ToInt16(ds.Tables[0].Rows[0].ItemArray[26].ToString()),
        ...
        [HttpPost]
        public ActionResult TFl2(List<string> lst, bool snd, string img, string btnClose = "default", List<Int64> idlst = null)
        {
            if (Session["uid"] == null)
            {
                return RedirectToAction("Error", "Error", new { msg = "Session Expired" });
            ...
            try
            {
                ...
                //        iwpro.UpdateTFL2Verification(id, uid, lst[1].ToString(), finaldate, Convert.ToInt16(lst[4]), resncode, null, null, cbsclientdtls, cbsJointDtls, Convert.ToDouble(lst[5]), Convert.ToDouble(Session["RVERFNHIGHAMT"]), decsn, Session["LoginID"].ToString(), Convert.ToInt16(lst[14]));
                    ...
                    while (count > 0)
                    {
                        ...
                        if (checkid == false)
                        {
                            def = new L2Helper
                            {
                                ...
                                DbtAccountNoOld = ds.Tables[0].Rows[index].ItemArray[2].ToString(),
                                DateOld = ds.Tables[0].Rows[index].ItemArray[3].ToString(),
                                //  AIStatus = ds.Tables[0].Rows[index].ItemArray[27].ToString(),
                            };
                            //ids.Add(def.ID);
                            objectlst.Add(def);
                        }
        ...
        public PartialViewResult GetCBSDtls(string ac = null, string strcbsdls = null, string strJoinHldrs = null)
        {
            ...
            try
            {
                if (ac != null && (strcbsdls == null || strcbsdls == ""))
                {
                    ...
                    return PartialView("_TFL2GetCBSDtls", model);
                }
                else
                {
                    //cbstetails model = new cbstetails();
        ...
        public PartialViewResult RejectReason(int id = 0)
        {
            ...
            return PartialView("_TFL2RejectReason", rjrs);
        }
