                ...
                success: function (result) {
                    if (result == false) {
                       // window.location = RootUrl + 'IWL1/Selection';
                        ...
                        window.location = RootUrl + 'IwVerSelection/Index?Flg=L3';
                    }
                }
            });
        }
...
if (invalidaccflag == "Invalid Account")
{
    ...
    function common(val) {
        ...
        if (cnt < tt.length) {
            ...
            GetL1ByAndStatus(tt[cnt].ID);
            ModifiedHighlight(cnt);
...
function GetSignData(inputdocumenttype) {
    ...
    $.ajax({
        ...
        url: RootUrl + "IWL3/GetSignatureData",
        ...
        success: function (data) {
            ...
            signatures.forEach(function (signature, index) {
                ...
                if (fileType.startsWith("image")) {
                    ...
                    img.alt = signature.Remark || "No remark available"; // Set the alt text
                ...
                if (documentType == "DOCUMENT" || documentType == "MANDATE") {
                    ...
                    remark.style.display = "block"; // Make remark appear below the image
...
function GetL1ByAndStatus(id) {

    debugger;

    $.ajax({
        url: RootUrl + 'IWL3/GetIWL1L2ByAndStatus',
        contentType: 'application/json; charset=utf-8',
        dataType: 'html',
        data: { id: id },
        success: function (data) {
            ...
            if (data != null) {
                ...
                var L1_data = JSON.parse(data);

					document.getElementById("L1Byid").innerHTML = L1_data.L1By;
					document.getElementById("L1Statusid").innerHTML = L1_data.L1Status === "2" ? "Accept" : L1_data.L1Status === "3" ? "Reject" : L1_data.L1Status === "4" ? "Exception" : "Unknown Status";;

					document.getElementById("L2Byid").innerHTML = L1_data.L2By;
					document.getElementById("L2Statusid").innerHTML = L1_data.L2Status === "2" ? "Accept" : L1_data.L2Status === "3" ? "Reject" : L1_data.L2Status === "4" ? "Exception" : "Unknown Status";
               

				if (L1_data.L1Status === "3") {
					 document.getElementById("L1rejectOrException").style.display = "block";
					 document.getElementById("L1rejectOrException").innerHTML = L1_data.RejectReasonDiscription;
				 } else if (L1_data.L1Status === "4") {
					 document.getElementById("L1rejectOrException").style.display = "block";
					 document.getElementById("L1rejectOrException").innerHTML = L1_data.ExRejectReasonDiscription;
				 } else {
					 document.getElementById("L1rejectOrException").style.display = "none";
				 }


				 if (L1_data.L2Status === "3") {
					 document.getElementById("L2rejectOrException").style.display = "block";
					 document.getElementById("L2rejectOrException").innerHTML = L1_data.RejectReasonDiscription;
				 } else if (L1_data.L2Status === "4") {
					 document.getElementById("L2rejectOrException").style.display = "block";
					 document.getElementById("L2rejectOrException").innerHTML = L1_data.ExRejectReasonDiscription;
				 } else {
					 document.getElementById("L2rejectOrException").style.display = "none";
				 }
...
function ModifiedHighlight(inputcnt) {
    debugger

    if (tt[inputcnt].StrModified.charAt(0) == "1") {
    ...
    if (tt[inputcnt].StrModified.charAt(1) == "1") {
    ...
    if (tt[inputcnt].StrModified.charAt(2) == "1") {
    ...
    if (tt[inputcnt].StrModified.charAt(3) == "1") {
    ...
    if (tt[inputcnt].StrModified.charAt(4) == "1") {
    ...
    if (tt[inputcnt].StrModified.charAt(5) == "1") {
