$(document).ready(function () {
    ...
    $("#btnsrch").click(function () {
        ...
        if (flg == true) {
            ...
            $.ajax({
                //url: RootUrl + 'IWSearch/Index',
                //data: JSON.stringify({ extrafields: extrvalarry, P2f: p2f }),
                url: RootUrl + 'Query_IW_Module/SearchIndex',
                data: {
                        ProcessingDate: extrvalarry[0], ToProcessingDate: extrvalarry[1], XMLSerialNo: extrvalarry[2], XMLAmount: extrvalarry[3],
                        AccountNo: extrvalarry[4], XMLPayorBankRoutNo: extrvalarry[5], XMLTrns: extrvalarry[6], clrtype: extrvalarry[7], P2f: p2f, EOD: eod
                      },
                //type: 'POST',
...
function selectedcheque(selectchq) {
    ...
    $.ajax({
        ...
        //url: RootUrl + 'Query_IW_Module/CheqDetls',
        type: 'POST',
        dataType: 'html',
        data: { id: selectchq },
        success: function (data) {
