       ...
       // document.getElementById('accnt').focus();
        ...
        if (document.getElementById('accnt').value != "") {
            ...
            $.ajax({
                ...
                url: RootUrl + 'IWL2_New/GetCBSDtls',
                dataType: 'html',
                type: 'POST',
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result == false) {
                        ...
                        window.location = RootUrl + 'IwVerSelection/Index?Flg=L2';
...
function GetSignData(inputdocumenttype) {
    ...
    $.ajax({
        ...
        url: RootUrl + "IWL2_New/GetSignatureData",
        ...
        success: function (data) {
            ...
            // Assuming the structure of data remains similar for all types
            ...
            items.forEach(function (item, index) {
                ...
                var fileType = getFileTypeFromBase64(item);

                if (fileType.startsWith("image")) {
                    var img = document.createElement("img");
                    img.src = "data:image/jpeg;base64," + item;
                    img.alt = item.Remark || "No remark available"; // Set alt text
                    ...
                    iframe.src = `data:application/pdf;base64,${item}`;
                    iframe.width = "300px";
                    iframe.height = "150px";
                    ...
                    button.onclick = function (event) {
                        event.preventDefault();
                        fullImageSign(`data:application/pdf;base64,${item}`);
                    };
                ...
                document.getElementById("operatingInstruction").value = data.SpecialRequirement;
                // Append image and remark to the wrapper
...
function GetL1ByAndStatus(id) {
    ...
    $.ajax({
        url: RootUrl + 'IWL2_New/GetL1ByandL1Status',
        contentType: 'application/json; charset=utf-8',
        dataType: 'html',
        data: { id: id },
        success: function (data) {
            ...
            if (data != null) {
               ...
               // document.getElementById("L1Statusid").innerHTML = L1_data.L1Status;
