    ...
    $("#btnsrch").click(function () {
        ...
        if (flg === true) {
            ...
            $.ajax({
                ...
                url: RootUrl + 'OW_QuerySearch/QuerySearch',
                data: {
                    ...
                    AccountNo: $("#AccountNo").val(), XMLPayorBankRoutNo: $("#XMLPayorBankRoutNo").val(), XMLTrns: $("#XMLTrns").val(), BranchCode: $("#BranchCode").val(), P2f: p2f, EOD: EOD
                },
...
function mrkRtn(rtnval) {
    ...
    if (rslt == false) {
        ...
        $.ajax({
            ...
            url: RootUrl + 'OW_QuerySearch/MarkRtn',
            type: 'POST',
            dataType: 'html',
...
function selectedcheque(selectchq) {
    ...
    $.ajax({
        ...
        url: RootUrl + 'OW_QuerySearch/CheqDetls',
...
function SlipImage() {
    ...
    if (lblval == "Slip Front Image") {
        ...
        $.ajax({
            ...
            url: RootUrl + 'OW_QuerySearch/slipImage',
            dataType: 'html',
            data: {
...
function ChangeImage(imagetype) {
    ...
    if (imagetype == "frntTiffimg") {
        ...
        $.ajax({
            ...
            url: RootUrl + 'OW_QuerySearch/getTiffImage',
            dataType: 'html',
