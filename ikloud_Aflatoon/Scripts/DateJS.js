...
$(document).ready(function () {
    $('#iwDate').bind("cut copy paste", function (e) {
        e.preventDefault();
    });
    ...
    $("#btnok").click(function () {
        ...
        if (result == false) {
            document.getElementById('iwDate').focus();
            document.getElementById('iwDate').select();
        }
        else {
    ...
    $("#btnRejct").click(function () {
        ...
        if ($("#iwDate").val() == "" || $("#iwDate").val().length < 6) {
    ...
    $("#btnback").click(function () {
        ...
        if (Modernizr.localstorage) {
            ...
            document.getElementById('iwDate').value = orderData.Date;
            document.getElementById('iwDate').focus();
        }
        //}
        ...
        if (Modernizr.localstorage) {
            ...
            if (scond == true) {
                for (var i = 0; i < cnt; i++) {
                    ...
                    var orderData = JSON.parse(localData.getItem("iwdate" + i));
            ...
            $.ajax({
                ...
                url: RootUrl + 'IWDataEntry/IWDate',
    ...
    $("#iwDate").keypress(function (event) {
    ...
    function commoncall(val) {
        ...
        if (cnt < tt.length) {
            ...
            document.getElementById('iwDate').value = "";
            document.getElementById('iwDate').focus();
            if (backbtn == true) {
                        ...
                        if (result == false) {
                            ...
                            if (tt != null && tt != "") {
                                ...
                                if (Modernizr.localstorage) {
                                    ...
                                    var localacct = window.localStorage;
                                    var chqdate = JSON.stringify(dtte);
                                    localacct.setItem(iwdate, chqdate);
...
function Dvalid() {
    ...
    var dat = document.getElementById('iwDate').value;
    if (dat == "") {
        //alert('aila');
