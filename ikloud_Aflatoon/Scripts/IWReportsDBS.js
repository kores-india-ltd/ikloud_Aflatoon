...
$(document).ready(function () {
    ...
    $("#btnreport").click(function () {
        ...
        window.open(RootUrl + 'IWReportDBS/IWActionReport?fromdate=' + $("#fromdate").val() + '&todate=' + $("#todate").val() + '&clrtypr=' + $("#clrtype").val() + '&reporttype=' + $("#rpttype").val() + '&vflevel=' + $("#verflevel").val() + '&UserName=' + $("#listuser").val() + '&filedwnldtype=' + $("#filedwnldtype").val() +'&expiryTime=' + $("#SessionExpiryTime").val());
