...
function getPayee() {
    ...
    if ($("#ChqAcno").val() != "") {
        $.ajax({
            url: RootUrl + 'OWSmbVerification1/GetSMBCBSDetails',
            dataType: 'html',
            data: { ac: $("#ChqAcno").val() },
...
function getowlogs() {
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            url: RootUrl + 'OWSmbVerification1/getOWlogs',
            dataType: 'html',
...
function ChangeImage(ImagePath) {
    ...
    if (ImagePath == "" || ImagePath == null) {
        ...
        $.ajax({
            url: RootUrl + 'OWSmbVerification1/getTiffImage',
            dataType: 'html',
...
function ChangeImageNew(ImagePath) {
    ...
    console.log(ImagePath);
    $.ajax({
        url: RootUrl + 'OWSmbVerification1/getTiffImageNew',
        dataType: 'html',
        data: { httpwebimgpath: ImagePath },
        success: function (Slipdata) {
            //debugger;
