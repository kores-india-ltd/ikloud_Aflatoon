...
function ChangeImage(ImagePath) {
    ...
    if (ImagePath == "" || ImagePath == null) {
        ...
        $.ajax({
            url: RootUrl + 'OWCDKCheckerVerification/getTiffImage',
            dataType: 'html',
...
$(document).ready(function () {
    ...
    //document.getElementById('FinalChqNo').readOnly = true;
    //document.getElementById('FinalSortcode').readOnly = true;
    //document.getElementById('FinalSAN').readOnly = true;
    //document.getElementById('FinalTransCode').readOnly = true;
