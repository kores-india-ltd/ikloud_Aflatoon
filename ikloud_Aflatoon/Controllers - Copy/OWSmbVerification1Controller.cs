...
namespace ikloud_Aflatoon.Controllers
{
    ...
    public class OWSmbVerification1Controller : Controller
    {
        //
        // GET: /OWL2/
            ...
            try
            {
                if (Session["uid"] != null)
                {
                    ...
                    if (owVeriEnableBranch == null || owVeriEnableBranch == "")
                    {
                        ...
                        return RedirectToAction("Index", "OWSmbVerification1", new { id = id });
                    }
                    else
                    {
        ...
        public ActionResult SelectionForBranchCode(SelectionForBranchCode selectionForBranchCode)
        {
            ...
            try
            {
                ...
                return RedirectToAction("Index", "OWSmbVerification1", new { id = verificationId, branchId = branch });
            }
            catch(Exception e)
            {
                string message = "";
