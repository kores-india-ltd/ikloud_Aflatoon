    ...
    public class OWL2Controller : Controller
    {
                    ...
                    if (NewApiCall == "Y")
                    {
                        ...
                        if (sBankNm == "DBS")
                        {
                            ...
                            else
                            {
                                ...
                                //    //            //string sCMPCResponse = getCustomerId(CMCPServiceURL, CMCPReqUID, CMCPReqClientId, jObject["relatedCustomerInfo"][iIndex]["relatedPartyCustomerId"].ToString().Trim());
                                ...
                                ////if (cbsdtls.NREFlag != null)
                                ////    Session["NR"] = cbsdtls.NREFlag;
                                ////else
                                ////    Session["NR"] = "";
        ...
        string GetCMCPCustomerName(string sResposne)
        {
            ...
            if (jObject["data"]["profileInfo"]["registeredName"] != null)
            {
                ...
                logerror(sResposne, sCustomerName);
            }
            else
            {
                //WriteState code to log error
