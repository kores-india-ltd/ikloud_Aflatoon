...
namespace ikloud_Aflatoon.Models
{
    ...
    public class CMSCustAdditionalInput : CMSCustProdMaster
    {
        ...
        public string Additional1_CUSPAI_DATA_SIZE { get; set; }
        public string Additional1_addition_datatype { get; set; }
        public string Additional1_master_serial { get; set; }
        public string Additional2_CUSPAI_DATA_SIZE { get; set; }
        public string Additional2_addition_datatype { get; set; }
        public string Additional2_master_serial { get; set; }
        public string Additional3_CUSPAI_DATA_SIZE { get; set; }
        public string Additional3_addition_datatype { get; set; }
        public string Additional3_master_serial { get; set; }
        public string Additional4_CUSPAI_DATA_SIZE { get; set; }
        public string Additional4_addition_datatype { get; set; }
        public string Additional4_master_serial { get; set; }
        public string Additional5_CUSPAI_DATA_SIZE { get; set; }
        public string Additional5_addition_datatype { get; set; }
        public string Additional5_master_serial { get; set; }
        public int SlipChequeCount { get; set; }
        //---------------------
