...
{
    public class Query_OW_ModuleController : Controller
    {
        //
        // GET: /Query_OW_Module/
        ...
        [HttpPost]
        public PartialViewResult Query1(List<string> extrafields = null, string P2f = null, string EOD = null) //IWSearch iwsrch
        {
            ...
            try
            {
                ...
                if (extrafields[7] != null && extrafields[7] != "")
                    strBranchCode = extrafields[7].ToString();
        ...
        public PartialViewResult SearchQuery(string ProcessingDate = null, string ToProcessingDate = null, string XMLSerialNo = null, string XMLAmount = null,
            string AccountNo = null, string XMLPayorBankRoutNo = null, string XMLTrns = null, string BranchCode = null, string P2f = null, string EOD = null) //IWSearch iwsrch
        {
            string strFromDate = null, strToDate = null, strCheqNo = null, strSortCode = null, strTransCode = null, strAccountno = null, strBranchCode = null;
            decimal amount = 0;
            try
            {
                ...
                if (strFromDate != null)
                {
                    ...
                    if (EOD == null || EOD == "")
                    {
                        logerror("In SearchQuery EOD function", "In SearchQuery EOD function" + " - >");
                        var Owsr = (from r in af.MainTransaction
                                    where (r.ProcessingDate >= tempdate) && (r.ProcessingDate <= Totempdate || Totempdate == null) && (r.CustomerId == custid) && (r.ChequeNoFinal == strCheqNo || strCheqNo == null) &&
                                    (r.FinalAmount == amount || amount == 0) && (r.FinalAccountNo == strAccountno || strAccountno == null) && (r.SortCodeFinal == strSortCode || strSortCode == null)
                                    && (r.TransCodeFinal == strTransCode || strTransCode == null) && (P2f == "true" ? r.DocType == "C" : r.DocType == r.DocType) && (r.BranchCode == strBranchCode || strBranchCode == null)
                    ...
                    {
                        logerror("In SearchQuery EOD else function", "In SearchQuery EOD else function" + " - >");
                        var Owsr = (from r in OWpro.EOD_MainTransactions
                                    where (r.ProcessingDate >= tempdate) && (r.ProcessingDate <= Totempdate || Totempdate == null) && (r.CustomerId == custid) && (r.ChequeNoFinal == strCheqNo || strCheqNo == null) &&
                                    (r.FinalAmount == amount || amount == 0) && (r.FinalAccountNo == strAccountno || strAccountno == null) && (r.SortCodeFinal == strSortCode || strSortCode == null)
                                    && (r.TransCodeFinal == strTransCode || strTransCode == null) && (P2f == "true" ? r.DocType == "C" : r.DocType == r.DocType) && (r.BranchCode == strBranchCode || strBranchCode == null)
        ...
        [HttpPost]
        public PartialViewResult Query(IWSearch search, string p2f = null)
        {
            string strFromDate = null, strToDate = null, strCheqNo = null, strSortCode = null, strTransCode = null, strAccountno = null, strBranchCode = null;
            decimal amount = 0;
            try
            {
                logerror("In SearchQuery function", "In SearchQuery function" + " - >");
                if (search.ProcessingDate != null && search.ProcessingDate != "")
                    strFromDate = search.ProcessingDate.ToString();
                if (search.ToProcessingDate != null && search.ToProcessingDate != "")
                    strToDate = search.ToProcessingDate.ToString();
                if (search.XMLSerialNo != null && search.XMLSerialNo != "")
                    strCheqNo = search.XMLSerialNo.ToString();
                if (search.XMLAmount != null && search.XMLAmount != 0)
                    amount = Convert.ToDecimal(search.XMLAmount.ToString());
                else
                    amount = 0;
                if (search.AccountNo != null && search.AccountNo != "")
                    strAccountno = search.AccountNo.ToString();
                if (search.XMLPayorBankRoutNo != null && search.XMLPayorBankRoutNo != "")
                    strSortCode = search.XMLPayorBankRoutNo.ToString();
                if (search.XMLTrns != null && search.XMLTrns != "")
                    strTransCode = search.XMLTrns.ToString();
                if (search.BranchCode != null && search.BranchCode != "")
                    strBranchCode = search.BranchCode.ToString();
