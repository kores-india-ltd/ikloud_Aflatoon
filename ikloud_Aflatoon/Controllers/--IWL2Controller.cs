    ...
    public class IWL2Controller : Controller
    {
        ...
        public ActionResult IWl2(List<string> lst, bool snd, string img, string btnClose = "default", List<Int64> idlst = null)
        {
            ...
            try
            {
                ...
                //        if (lst[11] != null)
                //            if (lst[11].ToString() != "")
                //                resncode = Convert.ToInt32(lst[11]);

                //        Int64 id = Convert.ToInt64(lst[0]);
                //        iwpro.UpdateIWL2Verification(id, uid, lst[1].ToString(), lst[2].ToString(), Convert.ToInt16(lst[4]), resncode, null, null, lst[12].ToString(), lst[13].ToString(), Convert.ToDouble(lst[6]), Convert.ToDouble(Session["RVERFNHIGHAMT"]), lst[3].ToString(), @Session["LoginID"].ToString());
                //        lst.RemoveRange(0, 14);
                //    }
                //}
