...
namespace ikloud_Aflatoon.Controllers
{
    public class CreateUserNewController : Controller
    {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    else
                    {
                        ...
                        if (Request.Form["SelectRoles"] != "")
                        {
                            ...
                            var roleMasters = (from a in af.RoleMaster
                                               where a.IsActive == 1 && a.ID == usermaster.RoleId
                                               //orderby a.RoleName
                                               select new
                                               {
                                                   a.ID,
                            ...
                            selectRoleName = roleMasters.RoleName;
                        }
                        ...
                        uma.comments = "Roles[" + selectRoleName + "]";
                        ...
                        if (Accesslevel == "ORG")
                        {
                            ...
                            if (dsdomin.Tables[0].Rows.Count > 0)
                            {
                                ...
                                while (count > 0)
                                {
                                    ...
                                    Domains = Domains + "," + dsdomin.Tables[0].Rows[index].ItemArray[0];
        ...
        [HttpPost]
        public ActionResult RejectUser1(UserMaster usermaster)
        {
            //int uid = (int)Session["uid"];
            if (Session["uid"] == null)
            {
        ...
        public JsonResult GetUserDetails(string accessLevel = null, Int64 currentId = 0)
        {
            List<string> customerlist = new List<string>();
            ...
            try
            {
                ...
                if(accessLevel == "ORG")
                {
                    var result = (from a in af.UserOrganizationMappings
                                 from d in af.OrganizationMasters
                                 orderby d.Id
                                 where a.OrganizationId == d.Id && a.UserId == currentId
                                  select new
                                 {
                                     OrgnizationName = d.Name,
                                     OrgnizationID = d.Id
                    ...
                    {
                        orgnizationName = orgnizationName + item.OrgnizationName + ",";
                    }
                ...
                {
                    var Cust = (from a in af.UserCustomerMappings
                                from d in af.CustomerMasters
                                    //  from o in udb.OrganizationMasters
                                orderby d.Id
                                where a.CustomerId == d.Id && a.UserId == currentId
                                select new
                                {
                                    Customer = d.Name,
                                    CustomerID = d.Id
                ...
                {
                    var Dom = (from a in af.DomainUserMapMasters
                                from d in af.DomainMaster
                                    //  from o in udb.OrganizationMasters
                                orderby d.Id
                                where a.DomainId == d.Id && a.UserId == currentId
                               select new
                                {
                                    DomainName = d.Name,
                                    DomainID = d.Id
                    ...
                    {
                        domainName = domainName + item.DomainName + ",";
                    }
                }

                userData.OrganizationNames = orgnizationName;
                userData.CustomerNames = customerName;
                userData.DomainNames = domainName;
                //userData.DomainNames = domainName != "" ? (domainName.IndexOf(',') != -1 ? domainName.Remove()) : domainName ;
        ...
        public JsonResult GetChangeRequest(Int64 currentId = 0)
        {
            try
            {
                var latestDate = af.UserMasterActivities
                   .Where(a => a.UserId == currentId)
                   .OrderByDescending(a => a.Actiondate)
                   .Select(a => DbFunctions.TruncateTime(a.Actiondate)) // Select the date part only
                   .FirstOrDefault();
                                
                if (latestDate != null)
                {
                    var result = af.UserMasterActivities
                                   .Where(a => a.UserId == currentId && DbFunctions.TruncateTime(a.Actiondate) == latestDate)
                                   .OrderByDescending(a => a.Actiondate)
                                   .Select(a => new
                                   {
                                       ID = a.ID,
                ...
                {
                    //Console.WriteLine("No records found for the specified user.");
        ...
        public ActionResult UserJob()
        {
            try
            {
                ...
                usmstr = (from a in adc.UserMasters
                          where a.UserDeleted == true && a.IsActive == 4
                          select a).ToList();
        ...
        //[HttpPost]
        public ActionResult ResetUser(Int32 id)
        {
            try
            {
                int seeionuid = (int)Session["uid"];
                ...
                //{
                    ...
                    usermaster.UserDeleted = false;
                    
                    //----------------- User ActivitiesLogs------
                    UserMasterActivity uma = new UserMasterActivity();

                    uma.Action = "User Reset";
                    uma.ActionBy = seeionuid;
                    uma.Actiondate = DateTime.Now;
                    uma.UserId = usermaster.ID;
                    // uma.comments = "Roles[" + allroles + "]";
                    ...
                    ulc.SaveChanges();
                    adc.SaveChanges();
                    return RedirectToAction("UserJob");
