    ...
    public class IWL3Controller : Controller
    {
        ...
        public ActionResult Index(string clrtype = null, string vftype = null)
        {
            ...
            try
            {
                ...
                SqlDataAdapter adp = new SqlDataAdapter("IWL3Verification_New", con);
                ...
                adp.Fill(ds);
                var objectlst = new List<IWTempL3VerificationModel>();
                IWTempL3VerificationModel def;

                if (ds.Tables[0].Rows.Count > 0)
                {
                    def = new IWTempL3VerificationModel
                    {
                    ...
                    //return RedirectToAction("IWIndex", "Home", new { id = 1 });
                     return RedirectToAction("Index", "IwVerSelection", new { Flg = "L3", id = 1 });
            }
            catch (Exception e)
            {
                string message = "";
                ...
                logerror("In IWL3 Index GET Catch==>>" + message, "InnerExp===>>" + innerExcp);
        ...
        public ActionResult IWl3(List<string> lst, bool snd, string img, string btnClose = "default", List<Int64> idlst = null)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < ttcnt - 1; i++)
                {
                    ...
                    UpdateIWL3Verification(id, uid, lst[4].ToString(), lst[5].ToString(), lst[6].ToString(), lst[7].ToString(), lst[1].ToString(), Convert.ToDouble(lst[2]), lst[3].ToString(), stu, resncode, rejctdecrptn, cbdclnts, cbdJointdtls, @Session["LoginID"].ToString(), PayeeName, exresncode, exrejctdecrptn, FinalModified);
                ...
                if (btnClose == "Close")
                {
                    ...
                    {
                        iwpro.UnlockRecords(idlst[p], "L3", 0, null, null, 0);
                    }
                    return Json(false);
                }
            ...
            catch (Exception e)
            {
                ...
                logerror("In IWL3 Index Post Catch==>>" + message, "InnerExp===>>" + innerExcp);
        ...
        public void UpdateIWL3Verification(
      long id,
      int uid,
      ...
      string FinalModified)
        {
            ...
            using (SqlCommand cmd = new SqlCommand("UpdateIWL3Verification_New", con))
            {
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                catch (Exception e)
                {
                    ...
                    if (e.InnerException != null)
                        innerExcp = e.InnerException.Message;
                    logerror("In UpdateIWL3Verification Catch ===>>" + message, "InnerExp==>" + innerExcp);
                                    ...
                                    if (jObject["accountStatus"] != null)
                                    {
                                        ...
                                        if (jObject["accountStatus"].ToString().Trim() == "Active")
                                        {
                                            ...
                                            if (jObject["freezeStatusCode"].ToString().Trim() == "T")
                                            {
                                                ...
                                                //cbsdtls.PayeeNameList = null;
                                               // cbsdtls.sInvalidAcFlag = "T";
                                                cbsdtls.sInvalidAcFlag = "F";  //allowing total freze
                                            }
                                            else if (jObject["freezeStatusCode"].ToString().Trim() == "C")
                                            {
                                                ...
                                                //cbsdtls.PayeeNameList = null;
                                                cbsdtls.sInvalidAcFlag = "F"; //allowing credit freze
                                            }
        ...
        string GetCMCPCustomerNameTest()
        {
            ...
            string sCustomerName = "TestName1";
        ...
        public JsonResult GetSignatureData(string ac = null, string documentType = null)
        {
            ...
            logerror("in IwL3 GetSignatureData==>", "");
            logerror("in IwL3 GetSignatureData==>", "ac==>" + ac + "documenttype==>" + documentType);
            //CASA variables
            var CasaClientId = ConfigurationManager.AppSettings["CasaClientId"].ToString();
            var CasaCorellationId = ConfigurationManager.AppSettings["CasaCorellationId"].ToString();
            var CasaServiceURL = ConfigurationManager.AppSettings["CasaServiceURL"].ToString();
            ...
            try
            {
                ...
                else
                {
                    if (jObject["accountClosedFlag"].ToString().Trim().ToUpper() != "Y" && (jObject["productType"].ToString() != "" || jObject["productType"].ToString() != null))
                    {
                        ...
                        logerror("in IWL3 GetSignatureData==>", "productType==>" + ProductType.ToString());
                    }
                ...
                logerror("in IWL3 GetSignatureData==>", "idlst==>" + idlst[0].ToString());
                ...
                logerror("in IWL3 GetSignatureData==>", "signatureResponses==>" + signatureResponses[0].ToString());
                ...
                logerror("in IWL3 GetSignatureData==>", "SpecialRequirement==>" + spReq.ToString());
                ...
                logerror("in IWL3 GetSignatureData==>", "SpecialInstruction==>" + spInst.ToString());
            ...
            catch (Exception e)
            {
                ...
                logerror("In IWL3 GetSignatureData Catch==>>" + message, "InnerExp===>>" + innerExcp);
            }
        ...
        public List<Int64> FetchthevalueIDfromsignaturedocumentlist(string signatureDocumentListUrl, string token, string ac, string documentType, string codeValueCdstr, string CMCPCountry, string CMCPReqUID, string CMCPReqClientId)
        {
            ...
            catch (Exception e)
            {
                ...
                logerror("In  IWL3 FetchthevalueIDfromsignaturedocumentlist Catch==>>" + message, "InnerExp===>>" + innerExcp);
            }
        ...
        public string SignatureBlob(Int64 compositeId, string url, string token, string CMCPCountry, string CMCPReqUID, string CMCPReqClientId)
        {
            ...
            catch (Exception e)
            {
                ...
                logerror("In  IWL3 SignatureBlob Catch==>>" + message, "InnerExp===>>" + innerExcp);
            }
        ...
        public string SpecialRequirement(string url, string ac, string codeValueCd, string token, string CMCPCountry, string CMCPReqUID, string CMCPReqClientId)
        {
            ...
            catch (Exception e)
            {
                ...
                logerror("In IWL3 SpecialRequirement Catch==>>" + message, "InnerExp===>>" + innerExcp);
            }
        ...
        public string SpecialInstruction(string url, string ac, string codeValueCd, string token, string CMCPCountry, string CMCPReqUID, string CMCPReqClientId)
        {
            ...
            catch (Exception e)
            {
                ...
                logerror("In IWL3 SpecialInstruction Catch==>>" + message, "InnerExp===>>" + innerExcp);
            }
        ...
        public JsonResult GetIWL1L2ByAndStatus(Int64 id = 0)
        {
            try
            {
                SqlDataAdapter SQLDA = new SqlDataAdapter("GetIWL1L2ByAndStatus", con);
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    ob.L2By= ds.Tables[0].Rows[0]["L2By"] == null ? "" : ds.Tables[0].Rows[0]["L2By"].ToString();
                    ob.L2Status= ds.Tables[0].Rows[0]["L2Status"] == null ? "" : ds.Tables[0].Rows[0]["L2Status"].ToString();
            ...
            {
                logerror("in ILW3 GetL1ByandL1Status catch==>" + e.Message.ToString(), "InnerExp==>" + e.InnerException.ToString());
        ...
        public CPPS_NewAccFlag GetCPPSFlagAndPayeeNewAccFlag(Int64 id = 0)
        {
            ...
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand("IWGetMICRRepairStausandCPPSFlag", con))
                {
                    ...
                    cmd.Parameters.AddWithValue("@Module", "L3");
        ...
        public PartialViewResult RejectReason(int id = 0)
        {
            ...
            return PartialView("_L3RejectReason", rjrs);
        }
        ...
        public string GetBOFDRoutNo(Int64 id = 0)
        {
            ...
            catch (Exception e)
            {
                ...
                logerror("In IWL3GetBOFDRoutNo Catch==>> " + message, "InnerExp===>>" + innerExcp);
            }
