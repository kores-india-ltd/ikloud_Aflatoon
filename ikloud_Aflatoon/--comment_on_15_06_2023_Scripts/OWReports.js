...
$(document).ready(function () {
    ...
    $("#btnreport").click(function () {
        ...
        window.open(RootUrl + 'OWReports/OWActionReport?fromdate=' + $("#fromdate").val() + '&todate=' + $("#todate").val() + '&clrtypr=' + $("#clrtype").val() + '&reporttype=' + $("#rpttype").val() + '&vflevel=' + $("#verflevel").val() + '&filedwnldtype=' + $("#filedwnldtype").val() + '&domainid=' + $("#gridDomains").val() + '&scanningtype=' + ScanningType);
