            ...
            success: function (data) {
                ...
                if (document.getElementById("PayeeName").value != "") {
                    ...
                    if (document.getElementById("partialSrcFnds").value == "N") {
                        ...
                        //Source of Funds
                        $.ajax({
                            url: RootUrl + 'OWL2/GetSourceofFunds',
                            dataType: 'html',
                            data: {},
                            async: false,
                            cache: false,
                            success: function (signview) {
                                ...
                                $('#SrcFnds').html(signview);
                                $('#SrcFnds').html(signview).focus();

                                //if (document.getElementById("ddSrcFnds").value != "")
...
$(document).ready(function () {
    ...
    //For Back Image display
    $("#accnt").focus(function (event) {
       // debugger;
    ...
    //For Front Image display
    $("#Decision").click(function (event) {
        debugger;
            ChangeImage('FGray');
    });
  
    $("#Decision").focus(function (event) {
        //debugger;
        ChangeImage('FGray');
    });
    ...
    $("#accnt").focusout(function (event) {
        ...
        if (accVal === 'Y') {
            var len = document.getElementById("accnt").value.length;

            var acmin = document.getElementById('acmin').value;
            //if (len !== 16) {
                console.log('In if ac foucusout');
            /*if (finalAccount.length.toString().trim() >= acmin) {*/
            if (finalAccount.length.toString().trim() >= document.getElementById("MinAclen").value && finalAccount.length.toString().trim() <= document.getElementById("MaxAclen").value) {
                    document.getElementById("accnt").value = finalAccount;
                    finalAccount = "";
        ...
        var AccLen = document.getElementById("accnt").value.length;
    });
    ...
    $("#accnt").keydown(function (event) {
        ...
        //if (Acct.length != 15) {
        //    alert("Account no should be of 15 digits!");
        //    document.getElementById('accnt').focus();
        //    return false;
        //}
        //if (isNaN(Acct)) {
    ...
    if (tt.length > 0) {
        ...
        if (tt[1].InstrumentType == "S") {
            ...
            if (nreOrnro == "NRE") {
                ...
                //document.getElementById('txtSrcFnds').value = tt[1].DraweeName;
        ...
        if (cnt < tt.length) {
            ...
            //============ amol changes for setting the sourceOfFunds values on 02/11/2022 end ============
                ...
                if (tt[cnt].CreditAccountNo != "" && tt[cnt].CreditAccountNo != null) {
                    $("#accnt").value=tt[cnt].CreditAccountNo;
                    var aNew = $("#accnt").val();
                    //debugger;
                    $.ajax({
                        ...
                        data: { ac: $("#accnt").val(), strcbsdls: tt[cnt].CBSAccountInformation, strJoinHldrs: tt[cnt].CBSJointAccountInformation, callby: "Normal", payeename: tt[cnt].PayeeName },
                        success: function (data) {
                            cbsbtn = true;
                            $('#cbsdetails').html(data);
...
function IWLICQC() {
    ...
    if (document.getElementById('partialSrcFnds').value == "N") {
        ...
        if (nreOrnro == "NRE") {
            ...
            if (document.getElementById('ddSrcFndsNRO').value == "" || document.getElementById('ddSrcFndsNRO').value == null || document.getElementById('ddSrcFndsNRO').value == 0) {
    ...
    if (narrationReqirdflg == true) {
        ...
        else if ($("#nartext").val().length < 12) {
            alert('Please enter minimum 12 characters in narration!');
            document.getElementById('nartext').focus();
            return false;
        }
    }
    ...
    if (tt[valcnt].InstrumentType == "C") {
        ...
        //if (postdate <= fnldate && (document.getElementById('Decision').value == "A" || document.getElementById('Decision').value == "a")) {
        //    alert("Post dated cheque!");
        //    document.getElementById('ChqDate').focus();
        //    return false;
        //}
        //if (staledate >= fnldate && (document.getElementById('Decision').value == "A" || document.getElementById('Decision').value == "a")) {
        //    alert("Stale cheque!");
        //    document.getElementById('ChqDate').focus();
        //    return false;
        ...
        //debugger;
        //var sDate1 = staledate.substring(0, 2);
        //var sDate2 = staledate.substring(3, 5);
        //var sDate3 = staledate.substring(6, 10);

        //var sDate = staledate.substring(6, 10) + '-' + staledate.substring(3, 5) + '-' + staledate.substring(0, 2);

        //var pDate1 = postdate.substring(0, 2);
        //var pDate2 = postdate.substring(3, 5);
        //var pDate3 = postdate.substring(6, 10);

        //var pDate = postdate.substring(6, 10) + '-' + postdate.substring(3, 5) + '-' + postdate.substring(0, 2);

        ////var staldat = new Date(staledate);
        //var staldat = new Date(sDate);
        ////var postdat = new Date(postdate);
        //var postdat = new Date(pDate);
    ...
    if ((postdate <= fnldate) || (staledate >= fnldate) ) {
        ...
        //if (userConfirmationPD == true && document.getElementById("blockkey").value == "0" && (document.getElementById('Decision').value == "A" || document.getElementById('Decision').value == "a"))
          if (userConfirmationPD == true && document.getElementById("blockkey").value == "0")
            return true;
        else if (userConfirmationPD == true && document.getElementById("blockkey").value == "1" && (document.getElementById('Decision').value == "R" || document.getElementById('Decision').value == "r"))
            return true;
        else {
            document.getElementById('ChqDate').focus();
            document.getElementById('ChqDate').select();
