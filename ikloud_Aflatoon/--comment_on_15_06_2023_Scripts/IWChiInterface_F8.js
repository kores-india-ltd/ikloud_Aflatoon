...
function CheckStatus() {
    DisableAllButtons();
    $.ajax({
        url: RootUrl + 'IWChiInterface_F8/CheckDEM_Session',
...
function TerminateRequest() {
    $.ajax({
        url: RootUrl + 'IWChiInterface_F8/TerminateRequest',
        contentType: 'application/json; charset=utf-8',
        dataType: 'JSON',
        data: {},
        success: function (data) {
...
function CreateRRF() {
    $.ajax({
        url: RootUrl + 'IWChiInterface_F8/CreateRrf',
        contentType: 'application/json; charset=utf-8',
        dataType: 'JSON',
        data: { Id: 10 },
        success: function (data) {
...
function UploadRRF() {
    $.ajax({
        url: RootUrl + 'IWChiInterface_F8/UploadRrf',
        contentType: 'application/json; charset=utf-8',
        dataType: 'JSON',
        data: { Id: 11 },
        success: function (data) {
...
function LoadResOcrRRF() {
    $.ajax({
        url: RootUrl + 'IWChiInterface_F8/LoadResOcrRrf',
        contentType: 'application/json; charset=utf-8',
        dataType: 'JSON',
        data: { Id: 12 },
        success: function (data) {
...
function LoadPXF() {
    $.ajax({
        url: RootUrl + 'IWChiInterface_F8/LoadPxf',
        contentType: 'application/json; charset=utf-8',
        dataType: 'JSON',
        data: { Id: 1 },
        success: function (data) {
...
function ExtractDataPXF() {
    $.ajax({
        url: RootUrl + 'IWChiInterface_F8/ExtractDataPxf',
        contentType: 'application/json; charset=utf-8',
        dataType: 'JSON',
        data: { Id: 2 },
        success: function (data) {
...
function GenerateRMI() {
    $.ajax({
        url: RootUrl + 'IWChiInterface_F8/GenerateRmi',
        contentType: 'application/json; charset=utf-8',
        dataType: 'JSON',
        data: { Id: 3 },
        success: function (data) {
...
function Show_Files_RRF() {
    ...
    $.ajax({
        url: RootUrl + 'IWChiInterface_F8/Show_Files_RRF',
        contentType: 'application/json; charset=utf-8',
        dataType: 'html',
        data: {},
        success: function (data) {
...
function Show_Files_PXF() {
    document.getElementById('basicModal').style.display = 'block';
    $.ajax({
        url: RootUrl + 'IWChiInterface_F8/Show_Files_PXF',
        contentType: 'application/json; charset=utf-8',
        dataType: 'html',
        data: {},
        success: function (data) {
...
function Show_Records_RRF() {
    document.getElementById('basicModal').style.display = 'block';
    $.ajax({
        url: RootUrl + 'IWChiInterface_F8/Show_Records_RRF',
        contentType: 'application/json; charset=utf-8',
        dataType: 'html',
        data: {},
        success: function (data) {
...
function Show_Records_PXF() {
    document.getElementById('basicModal').style.display = 'block';
    $.ajax({
        url: RootUrl + 'IWChiInterface_F8/Show_Records_PXF',
        contentType: 'application/json; charset=utf-8',
        dataType: 'html',
        data: {},
        success: function (data) {
