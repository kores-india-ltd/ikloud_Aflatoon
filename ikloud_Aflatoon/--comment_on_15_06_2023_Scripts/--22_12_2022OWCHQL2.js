            ...
            if (tt[1].NRESourceOfFundId == 0 && tt[1].NROSourceOfFundId == 0) {
                ...
                if (tt[1].NRESourceOfFundId > 0) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'html',
                        data: { ID: tt[1].NRESourceOfFundId, schemeType: 'NRE' },
                        async: false,
                        success: function (data) {
                            debugger;
                    ...
                    $.ajax({
                        ...
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'html',
                        data: { ID: tt[1].NROSourceOfFundId, schemeType: 'NRO' },
                        async: false,
                        success: function (data) {
                            debugger;
                            document.getElementById('txtSrcFnds').value = '';
                ...
                if (tt[cnt].NRESourceOfFundId == 0 && tt[cnt].NROSourceOfFundId == 0) {
                    ...
                    if (tt[cnt].NRESourceOfFundId > 0) {
                        $.ajax({
                            ...
                            contentType: 'application/json; charset=utf-8',
                            dataType: 'html',
                            data: { ID: tt[cnt].NRESourceOfFundId, schemeType: 'NRE' },
                            async: false,
                            success: function (data) {
                                debugger;
                                document.getElementById('txtSrcFnds').value = '';
                        ...
                        $.ajax({
                            ...
                            contentType: 'application/json; charset=utf-8',
                            dataType: 'html',
                            data: { ID: tt[cnt].NROSourceOfFundId, schemeType: 'NRO' },
                            async: false,
                            success: function (data) {
                                debugger;
                                document.getElementById('txtSrcFnds').value = '';
