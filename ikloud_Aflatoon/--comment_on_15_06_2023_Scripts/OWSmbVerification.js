...
/*$(document).ready(function () {
    //debugger;
        $.ajax({
            url: RootUrl + 'OWSmbVerification/GetSourceofFunds',
            dataType: 'html',
            data: {  },
            async: false,
            cache: false,
...
function IWLICQC() {
    ...
    var element1 = document.getElementById('ddSrcFnds');
    ...
    debugger;
    var pyName = document.getElementById('ChqPayeeName').value;
    var pName = pyName.trim();
	if(pName == ""){
    ...
    //}//if OWIsDataEntryAllowedForAccountNo
    ...
    //if (userConfirmationPD == true || userConfirmationSD == true || vPSD == true)
    //            return true;
    //        else {
    //            document.getElementById('ChqDate').focus();
    //            document.getElementById('ChqDate').select();
    ...
    //        return true;
    //    else if (userConfirmationPD == true && document.getElementById("blockkey").value == "1" && acntno == "999999999999")
    //        return true;
    //    else {
    //        document.getElementById('ChqDate').focus();
    //        document.getElementById('ChqDate').select();
    ...
    //    if (userConfirmationSD == true && document.getElementById("blockkey").value == "0")
    //        return true;
    //    else if (userConfirmationSD == true && document.getElementById("blockkey").value == "1" && acntno == "999999999999")
    //        return true;
    //    else {
    //        document.getElementById('ChqDate').focus();
    //        document.getElementById('ChqDate').select();
...
$(document).ready(function () {
    ...
    $("#ChqAcno").focusout(function (event) {
        ...
        //alert("ChqAcno focus out alert!!");

        //document.getElementById("ChqAcno").focus();

        //debugger;
        //if (document.getElementById("IwWebAPIPathAccountDtlsPermission").value == "Y") {
        //    if (finalAccount != "" && typeof finalAccount !== 'undefined') {
        //        if (finalAccount.length >= acFrom && finalAccount.length <= acTo) {
        ...
        //        }
        //    }
        //    else if (AccLen >= acFrom && AccLen <= acTo) {
        //        if (document.getElementById("IwWebAPIPathAccountDtlsPermission").value == "Y")
        //            getAccDetails();
        //        //getAccDetails();
        //    }
        ...
        //}
        //else {
        //    if (finalAccount != "" && finalAccount != undefined) {
        //        if (finalAccount.length >= acFrom && finalAccount.length <= acTo) {
        //            document.getElementById("EntryAccountNo").value = finalAccount;
        //            if (document.getElementById("IwWebAPIPathAccountDtlsPermission").value == "Y")
        //                getAccDetails();
