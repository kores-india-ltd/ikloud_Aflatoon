...
namespace ikloud_Aflatoon
{
    ...
    public partial class MainTransaction1
    {
        ...
        public Nullable<int> L3UserId { get; set; }
        public Nullable<byte> L3VerificationStatus { get; set; }
        public Nullable<byte> L3RejectReason { get; set; }
        public Nullable<bool> IsHighValue { get; set; }
        public Nullable<byte> CBSStatus { get; set; }
        public Nullable<int> CHIStatus { get; set; }
        public Nullable<System.DateTime> CHIFileCreationDate { get; set; }
        public Nullable<int> CHIFileId { get; set; }
        public string CHIFileName { get; set; }
        public Nullable<int> CHIRejectReason { get; set; }
        ...
        public Nullable<int> ExtentionHours { get; set; }
        public string ExtensionFileName { get; set; }
        public Nullable<int> ExtentionReason { get; set; }
        public Nullable<System.DateTime> ReturnDate { get; set; }
        public Nullable<int> ReturnReason { get; set; }
        public string ReturnFileName { get; set; }
        public Nullable<System.DateTime> ResUpdateTime { get; set; }
        public Nullable<System.DateTime> OackUpdateTime { get; set; }
        public Nullable<System.DateTime> CXFCreationTime { get; set; }
        public Nullable<System.DateTime> CXFCreationDate { get; set; }
        public Nullable<System.DateTime> CXFUploadTime { get; set; }
        ...
        public Nullable<byte> L1Action { get; set; }
        public Nullable<byte> L2Action { get; set; }
        public Nullable<byte> L3Action { get; set; }
        public Nullable<int> CHIRejectHandledBy { get; set; }
        ...
        public string LICSlipNo { get; set; }
